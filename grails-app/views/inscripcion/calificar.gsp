...
<html>
	...
	<div class="container_12" >
		...
		<div id="list-inscripcion" class="content scaffold-list" role="main">
			<h1><g:message code=" " default="Alumnos Por calificar" /></h1>
			...
			<thead>
				...
				<g:each in="${inscripcionInstanceList}" status="i" var="inscripcionInstance">
                                    <g:if test="${session.user.correo == inscripcionInstance.profesor.correo && inscripcionInstance.aceptado==true && inscripcionInstance.calificacion==-1}">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                            
                                                <td>${fieldValue(bean: inscripcionInstance, field: "alumno")}</td>
					
						<td><g:form url="[resource:inscripcionInstance, action:'asignarCalif',controller:'inscripcion']" >   
                                                    <div id="page-body" role="main" >
                                                    <br>
                                                    <input type="number" max="10" min="1" name="calificacion" required="true">  
